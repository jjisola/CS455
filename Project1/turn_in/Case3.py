...
dynamicRendezvous = np.array((50, 50), dtype=np.float32)
...
def gammaVelocity_y(chain, dt, multiplier, amp):
    # return amplitude * 2 * np.pi * frequency * np.cos(2 * np.pi * frequency * iteration * delta_t + phaseShift)
